...
public class DetailedReleaseSummary {
	...
	public DetailedReleaseSummary(final String projectId, final String versionId, final String projectName, final String version, final String versionComments, final String nickname, final String releasedOn, final String phase,
	...
	// Wasn't used anywhere and was causing problems
	...
	// return null;
	// }
	// return RiskPriorityDistribution.getDistributionEnum(distribution).getDisplayValue();
	// }
