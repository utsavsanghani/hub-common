...
public class NotificationProcessorTest {
	...
	public MockProcessor createMockedNotificationProcessor(List<VulnerabilityView> vulnerabilityList) throws Exception {
		...
		final VulnerabilityRequestService vulnerabilityRequestService = Mockito.mock(VulnerabilityRequestService.class);
		final HubRequestService hubRequestService = Mockito.mock(HubRequestService.class);
		Mockito.when(hubRequestService.getItem(Mockito.anyString(), Mockito.eq(ComponentVersionView.class))).thenReturn(compVersion);
	...
	public void testPolicyViolationAdd() throws Exception {
		...
		notifications.add(testUtil.createPolicyViolation(new DateTime(), EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION));
	...
	public void testPolicyViolationOverride() throws Exception {
		final SortedSet<NotificationContentItem> notifications = new TreeSet<>();
		notifications.add(testUtil.createPolicyOverride(new DateTime(), EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION));
		final Collection<NotificationEvent> eventList = createMockedNotificationProcessor().process(notifications);
	...
	public void testPolicyViolationCleared() throws Exception {
		final SortedSet<NotificationContentItem> notifications = new TreeSet<>();
		notifications.add(testUtil.createPolicyCleared(new DateTime(), EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION));
		final Collection<NotificationEvent> eventList = createMockedNotificationProcessor().process(notifications);
		assertFalse(eventList.isEmpty());
	...
	public void testPolicyViolationAndOverride() throws Exception {
		...
		final PolicyViolationContentItem policyViolation = testUtil.createPolicyViolation(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION);
		notifications.add(policyViolation);
		dateTime = dateTime.plusSeconds(1);
		final PolicyOverrideContentItem policyOverride = testUtil.createPolicyOverride(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION);
	...
	public void testPolicyViolationAndCleared() throws Exception {
		...
		notifications.add(policyViolation);
		dateTime = dateTime.plusSeconds(1);
		final PolicyViolationClearedContentItem policyCleared = testUtil.createPolicyCleared(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION);
	...
	public void testPolicyViolationAndClearedAndViolated() throws Exception {
		final SortedSet<NotificationContentItem> notifications = new TreeSet<>();
		DateTime dateTime = new DateTime();
		PolicyViolationContentItem policyViolation = testUtil.createPolicyViolation(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION);
		notifications.add(policyViolation);
		dateTime = dateTime.plusSeconds(1);
		final PolicyViolationClearedContentItem policyCleared = testUtil.createPolicyCleared(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION);
		notifications.add(policyCleared);
		dateTime = dateTime.plusSeconds(1);
		policyViolation = testUtil.createPolicyViolation(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION);
		notifications.add(policyViolation);
		final Collection<NotificationEvent> eventList = createMockedNotificationProcessor().process(notifications);
		assertPolicyDataValid(eventList, NotificationCategoryEnum.POLICY_VIOLATION);
	}
	...
	public void testPolicyViolationAndOverrideAndViolated() throws Exception {
		...
		notifications.add(policyViolation);
		dateTime = dateTime.plusSeconds(1);
		final PolicyOverrideContentItem policyCleared = testUtil.createPolicyOverride(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION);
		notifications.add(policyCleared);
		dateTime = dateTime.plusSeconds(1);
		policyViolation = testUtil.createPolicyViolation(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION);
		notifications.add(policyViolation);
	...
	public void testVulnerabilityAdded() throws Exception {
		...
		final VulnerabilityContentItem vulnerability = testUtil.createVulnerability(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION, vulnerabilities,
	...
	public void testVulnerabilityUpdated() throws Exception {
		...
		final DateTime dateTime = new DateTime();
		final List<VulnerabilitySourceQualifiedId> emptyVulnSourceList = Collections.emptyList();
		final VulnerabilityContentItem vulnerability = testUtil.createVulnerability(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION, emptyVulnSourceList,
	...
	public void testComplexVulnerability() throws Exception {
		...
		dateTime = dateTime.plusSeconds(1);
		final VulnerabilityContentItem vulnerability = testUtil.createVulnerability(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION, added, updated, deleted);
		notifications.add(vulnerability);
	...
	public void testComplexVulnerabilityMulti() throws Exception {
		...
		dateTime = dateTime.plusSeconds(1);
		final VulnerabilityContentItem vulnerability = testUtil.createVulnerability(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION, added1, updated1, deleted1);
		notifications.add(vulnerability);
		...
		dateTime = dateTime.plusSeconds(1);
		final VulnerabilityContentItem vulnerability2 = testUtil.createVulnerability(dateTime, EventTestUtil.PROJECT_NAME, EventTestUtil.PROJECT_VERSION_NAME, EventTestUtil.COMPONENT, EventTestUtil.VERSION, added2, updated2, deleted2);
